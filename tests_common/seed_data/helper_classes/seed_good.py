...
class SeedGood(seed_class.SeedClass):
    def post_good(self, data):
        item = make_requests.make_request('POST', base_url=self.base_url, url='/goods/',
                                          headers=self.export_headers, body=data).json()['good']
        self.add_good_document(item['id'])
        return item

    def get_goods(self):
        return make_requests.make_request('GET', base_url=self.base_url, url='/goods/',
    ...
    def add_good_to_draft(self, draft_id, good):
        ...
        make_requests.make_request("POST", base_url=self.base_url, url='/applications/' + draft_id + '/goods/',
    ...
    def add_good_document(self, good_id):
        ...
        make_requests.make_request("POST", base_url=self.base_url, url='/goods/' + good_id + '/documents/',
    ...
    def find_good_by_name(self, good_name):
        goods = make_requests.make_request('GET', base_url=self.base_url, url='/goods/', headers=self.export_headers).json()['goods']
    ...
    def add_open_draft_good(self, draft_id):
        ...
        make_requests.make_request("POST", base_url=self.base_url, url='/applications/' + draft_id + '/goodstypes/',
                                   headers=self.export_headers, body=data)
