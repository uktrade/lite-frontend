...
@fixture(scope="module")
def apply_for_standard_trade_control_application(api_test_client, context):
    timer = Timer()
    api_test_client.api_client.auth_exporter_user(api_test_client.context["org_id"])
    context.app_name = fake.bs()
    context.good_value = 1.21
    ...
    context.good_id = api_test_client.context.get("good_id")
    context.goods = data["application"]["goods"]
    timer.print_time("apply_for_standard_trade_control_application")


@fixture(scope="module")
def apply_for_open_trade_control_application(api_test_client, context):
    timer = Timer()
    api_test_client.api_client.auth_exporter_user(api_test_client.context["org_id"])
...
@fixture(scope="function")
def apply_for_standard_transhipment_application(api_test_client, context):
    timer = Timer()
    api_test_client.api_client.auth_exporter_user(api_test_client.context["org_id"])
    context.app_name = fake.bs()
    context.good_value = 1.21
    ...
    context.good_id = api_test_client.context.get("good_id")
    context.goods = data["application"]["goods"]
    timer.print_time("apply_for_standard_transhipment_application")


@fixture(scope="module")
def apply_for_ogel(api_test_client, context):
