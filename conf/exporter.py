...
FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED", False)
FEATURE_FLAG_NON_FIREARMS_TECHNOLOGY_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_TECHNOLOGY_ENABLED", False)
FEATURE_FLAG_NON_FIREARMS_MATERIAL_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_MATERIAL_ENABLED", False)
FEATURE_FLAG_NON_FIREARMS_PLATFORM_ENABLED = env.bool("FEATURE_FLAG_NON_FIREARMS_PLATFORM_ENABLED", False)

# Enable Security classified questions
FEATURE_FLAG_F680_SECURITY_CLASSIFIED_ENABLED = env.bool("FEATURE_FLAG_F680_SECURITY_CLASSIFIED_ENABLED", False)

if any(
    [
        FEATURE_FLAG_NON_FIREARMS_COMPONENT_ENABLED,
        FEATURE_FLAG_NON_FIREARMS_TECHNOLOGY_ENABLED,
