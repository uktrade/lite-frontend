...
# LITE SPIRE DMS archive API client
LITE_SPIRE_DMS_ARCHIVE_CLIENT_BASE_URL = env.str("LITE_SPIRE_DMS_ARCHIVE_CLIENT_BASE_URL")
LITE_SPIRE_DMS_ARCHIVE_CLIENT_HAWK_SECRET = env.str("LITE_SPIRE_DMS_ARCHIVE_CLIENT_HAWK_SECRET")
LITE_SPIRE_DMS_ARCHIVE_CLIENT_HAWK_SENDER_ID = env.str("LITE_SPIRE_DMS_ARCHIVE_CLIENT_HAWK_SENDER_ID", "lite-internal-frontend")
LITE_SPIRE_DMS_ARCHIVE_CLIENT_DEFAULT_TIMEOUT = env.int("LITE_SPIRE_DMS_ARCHIVE_CLIENT_DEFAULT_TIMEOUT", 2000)
LITE_SPIRE_DMS_ARCHIVE_EXAMPLE_ORGANISATION_ID = env.int("LITE_SPIRE_DMS_ARCHIVE_EXAMPLE_ORGANISATION_ID")
