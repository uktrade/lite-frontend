...
class FormGroup:
    ...
    def __init__(self, forms: list, show_progress_indicators=False):
        ...
        for form in forms:
            ...
            if alias:
                assert form.alias not in self._form_by_alias, f"Existing form found for alias '{alias}'. Every form must have a unique alias"
...
class Form:
    def __init__(
        ...
        """
        Args:
            index(int): Helpful mainly when form is part of a FormGroup
        """
