...
class PicklistPages(BasePage):
    ...
    def click_on_picklist_tab(self):
        self.driver.find_element(by=By.CSS_SELECTOR, value=self.PICKLIST_TAB).click()

    def click_on_picklist_edit_button(self):
        self.driver.find_element(by=By.ID, value=self.BUTTON_EDIT_ID).click()
    ...
    def click_on_picklist_type_sub_nav(self, type):
        self.driver.find_element(by=By.ID, value=self.LINK_PICKLIST_TYPE_SUB_NAV_ID_PREFIX + type).click()

    def click_on_picklist_add_button(self):
        self.driver.find_element(by=By.ID, value=self.BUTTON_ADD_ID).click()

    def get_text_of_picklist_page_body(self):
        return self.driver.find_element(by=By.CSS_SELECTOR, value=self.PICKLIST_PAGE_BODY).text
    ...
    def type_into_picklist_name(self, name):
        self.driver.find_element(by=By.NAME, value=self.PICKLIST_NAME_FIELD).send_keys(name)

    def type_into_picklist_description(self, description):
        self.driver.find_element(by=By.NAME, value=self.PICKLIST_DESCRIPTION_FIELD).send_keys(description)

    def clear_picklist_name_and_description(self):
        self.driver.find_element(by=By.NAME, value=self.PICKLIST_NAME_FIELD).clear()
        self.driver.find_element(by=By.NAME, value=self.PICKLIST_DESCRIPTION_FIELD).clear()
    ...
    def context_suggestions_are_displayed(self):
        return self.driver.find_element(by=By.CSS_SELECTOR, value=self.CONTEXT_SUGGESTIONS_OVERLAY).is_displayed()

    def get_context_suggestion_variable_name(self):
        return self.driver.find_element(by=By.CSS_SELECTOR, value=self.CONTEXT_SUGGESTIONS_OVERLAY).text

    def click_context_suggestion(self):
        self.driver.find_element(by=By.CSS_SELECTOR, value=self.CONTEXT_SUGGESTION).click()

    def get_errors(self):
        return self.driver.find_element(by=By.CSS_SELECTOR, value=self.ERRORS).text
