...
class FlagsListPage(BasePage):
    ...
    def click_edit_link(self):
        self.driver.find_elemebt(by=By.PARTIAL_LINK_TEXT, value="Edit").click()
    ...
    def click_deactivate_link(self):
        self.driver.find_elemebt(by=By.PARTIAL_LINK_TEXT, value="Deactivate").click()

    def click_reactivate_link(self):
        self.driver.find_elemebt(by=By.PARTIAL_LINK_TEXT, value="Reactivate").click()
