...
@pytest.fixture()
def withdraw_url(application_id):
    return reverse("applications:withdraw", kwargs={"pk": application_id})
...
def test_withdraw_application_GET(
    authorized_client,
    withdraw_url,
    requests_mock,
    api_url,
    ...
    response = authorized_client.get(withdraw_url)
