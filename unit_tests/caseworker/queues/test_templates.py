...
@pytest.mark.parametrize("duration", [0, None, 10, 25,])
...
@pytest.mark.parametrize("elapsed,remaining", [(0, 0), (None, None), (10, 10), (25, 25),])
def test_sla_display_days(elapsed, remaining):
    context = {"case": {"sla_days": elapsed, "sla_remaining_days": remaining,}}
    assert render_to_string("includes/sla_display.html", context)
