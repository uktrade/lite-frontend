...
@pytest.mark.parametrize(
    ...
    (
        ("invalid_user", [], False),
        ("LU_licensing_manager", [], True),
        ("LU_licensing_manager", [{"user": "LU_licensing_manager"}], False),
        ("LU_senior_licensing_manager", [{"user": "LU_licensing_manager"}], True),
        (
            "LU_senior_licensing_manager",
            [{"user": "LU_licensing_manager"}, {"user": "LU_senior_licensing_manager"}],
            False,
        ),
    ),
)
