...
from caseworker.core.services import get_mention_count


def test_user_case_note_mention_count(authorized_client, requests_mock):
    mentions_data = {
        "mentions": [
            {
    ...
    assert response.context["mention_count"] == 1
