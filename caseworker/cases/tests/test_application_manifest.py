...
from core.application_manifests.helpers import (
    get_caseworker_manifest_for_application_reference,
    get_caseworker_manifest_for_case,
)
...
def test_get_url_from_f680_manifest_via_case(data_standard_case):
    ...
    manifest = get_caseworker_manifest_for_case(case)
    assert manifest.urls.get_notes_and_timeline_url(
        case_id="11111111-1111-1111-1111-111111111111",
        queue_pk="22222222-2222-2222-2222-222222222222",
    ) == reverse(
