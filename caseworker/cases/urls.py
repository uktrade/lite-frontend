...
urlpatterns = [
    ...
    path("change-license-status/<uuid:license_pk>/", main.ChangeLicenseStatus.as_view(), name="change_license_status"),
    path(
        "change-license-status-confirmation/<uuid:license_pk>/<str:status>/",
        main.ChangeLicenseStatusConfirmation.as_view(),
        name="change_license_status_confirmation",
    ),
