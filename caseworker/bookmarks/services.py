...
def fetch_bookmarks(request, filter_data, all_flags, all_regimes):
    ...
    enricher = BookmarkEnricher(filter_data, all_flags, all_regimes)
...
class BookmarkEnricher:
    def __init__(self, filter_data, all_flags, all_regimes):
    ...
    def _enrich_bookmark_for_display(self, bookmark):
        try:
            ...
            out["url"] = self._url_from_bookmark(base_url, bookmark_filter)
    ...
    @staticmethod
    def _url_from_bookmark(base_url, bookmark_filter):
