...
})({"gKZIj":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "30f6e5d8ea47961b";
module.bundle.HMR_BUNDLE_ID = "e862e6621e3d580d";
...
},{}],"kH08K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _preferencesJs = require("../../../core/assets/javascripts/cookies/preferences.js");
var _preferencesJsDefault = parcelHelpers.interopDefault(_preferencesJs);
_preferencesJsDefault.default("#cookie-preferences-form", ".cookie-settings__confirmation", {
    usage: "cookies-usage"
});

},{"../../../core/assets/javascripts/cookies/preferences.js":"hKhFH","@parcel/transformer-js/src/esmodule-helpers.js":"bt0mQ"}],"hKhFH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var CookiePreferences = /*#__PURE__*/ function() {
    "use strict";
    function CookiePreferences(formSelector, confirmationSelector, radioButtons) {
        _helpers.classCallCheck(this, CookiePreferences);
        this.formSelector = formSelector;
        this.confirmationSelector = confirmationSelector;
        this.radioButtons = radioButtons;
        this.form = document.querySelector(this.formSelector);
    }
    _helpers.createClass(CookiePreferences, [
        {
            key: "boolToValue",
            value: function boolToValue(b) {
                return b ? "on" : "off";
            }
        },
        {
            key: "valueToBool",
            value: function valueToBool(value) {
                return value === "on";
            }
        },
        {
            key: "getPolicyOrDefault",
            value: function getPolicyOrDefault() {
                var cookie = _utils.getCookie(_consts.POLICY_COOKIE_NAME);
                var policy = _utils.getDefaultPolicy();
        ...
        },
        {
            ...
            value: function initFormValues() {
                var _this = this;
                var policy = this.getPolicyOrDefault();
                Object.entries(this.radioButtons).forEach(function(param) {
                    var _param = _helpers.slicedToArray(param, 2), cookieKey = _param[0], inputName = _param[1];
                    _this.form[inputName].value = _this.boolToValue(policy[cookieKey]);
                });
            }
        },
        {
            key: "setPoliciesCookie",
            value: function setPoliciesCookie() {
                var _this = this;
                var policy = {
                    settings: false,
                    usage: false,
                ...
                Object.entries(this.radioButtons).forEach(function(param) {
                    var _param = _helpers.slicedToArray(param, 2), cookieKey = _param[0], inputName = _param[1];
                    policy[cookieKey] = _this.valueToBool(_this.form[inputName].value);
                });
                _utils.setPoliciesCookie(policy.settings, policy.usage, policy.campaigns);
            }
        },
        {
            key: "displayConfirmation",
            value: function displayConfirmation() {
                var confirmationEl = document.querySelector(this.confirmationSelector);
        ...
        },
        {
            ...
            value: function bindForm() {
                ...
                this.form.addEventListener("submit", function(evt) {
                    evt.preventDefault();
                    _this.setPoliciesCookie();
                    _utils.setPreferencesCookie();
                    _this.displayConfirmation();
                    window.scrollTo(0, 0);
                    return false;
                });
            }
...
var initCookiePreferences = function(formSelector, confirmationSelector, radioButtons) {
    var cookiePreferences = new CookiePreferences(formSelector, confirmationSelector, radioButtons);
    cookiePreferences.initFormValues();
    cookiePreferences.bindForm();
};
exports.default = initCookiePreferences;

},{"@swc/helpers":"3OBsq","./consts":"8nHwb","./utils":"lT1Jx","@parcel/transformer-js/src/esmodule-helpers.js":"bt0mQ"}],"3OBsq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./_construct":"fWjGA","./_is_native_function":"6NiqX","./_get_prototype_of":"6HtCT","./_set_prototype_of":"lLpOg","@parcel/transformer-js/src/esmodule-helpers.js":"bt0mQ"}],"8nHwb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./consts":"8nHwb","@parcel/transformer-js/src/esmodule-helpers.js":"bt0mQ"}]},["gKZIj","kH08K"], "kH08K", "parcelRequire4557")
