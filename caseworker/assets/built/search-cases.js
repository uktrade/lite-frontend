...
})({"9EOz5":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "30f6e5d8ea47961b";
module.bundle.HMR_BUNDLE_ID = "6de2165671dd14a8";
...
},{}],"iJe4j":[function(require,module,exports) {
...
(function() {
    var isCalendarIntent = function isCalendarIntent(query) {
    ...
    var handleDateInput = function handleDateInput(fieldName) {
        datePicker = new _lightpickJsDefault.default({
            ...
            onSelect: function onSelect(start, end) {
                ...
                if (start && end) {
                    inputElement.value = inputElement.value.trim().replace(fieldName + ":", startField + ':"' + start.format("YYYY-MM-DD") + '" ' + endField + ':"' + end.format("YYYY-MM-DD") + '"');
    ...
    var autocomplete = new _autocompleteJsDefault.default({
        trigger: {
            ...
            condition: function condition(query) {
                if (isCalendarIntent(query)) return false;
                else return query.length > autocomplete.threshold && query !== " ";
            }
        },
        data: {
            src: function src() {
...
},{"./_construct":"fWjGA","./_is_native_function":"6NiqX","./_get_prototype_of":"6HtCT","./_set_prototype_of":"lLpOg","@parcel/transformer-js/src/esmodule-helpers.js":"bt0mQ"}]},["9EOz5","iJe4j"], "iJe4j", "parcelRequire4557")

//# sourceMappingURL=search-cases.js.map
