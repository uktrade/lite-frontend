...
exporter-e2e-selenium-test:
	...
	$(docker-e2e-exporter) exec exporter bash -c '$(wait-for-exporter) && pipenv run pytest --circleci-parallelize --headless -vv --gherkin-terminal-reporter ./ui_tests/exporter'
