...
from core.application_manifests.contants import ServiceType, ManifestType
...
def get_caseworker_manifest_for_case(case: Case) -> Type[BaseManifest]:
    return application_manifest_registry.get_manifest(ServiceType.CASEWORKER.value, case.type)
...
def get_exporter_manifest_for_application(application: Application) -> Type[BaseManifest]:
    return application_manifest_registry.get_manifest(ServiceType.EXPORTER.value, application.type)
