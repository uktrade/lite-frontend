...
class ProductSecurityFeatures:
    ...
    HELP_TEXT = "Information security features include cryptography, authentication, and cryptanalytic functions. They are often found in communication, wireless or internet-based products."
    if settings.FEATURE_C7_NCSC_ENABLED:
        ...
        HELP_TEXT = "Information security features include cryptography, authentication, and cryptanalytic functions. They are often found in communication, wireless or internet-based products, digital forensics and surveillance tools."
