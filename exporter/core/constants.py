...
CASE_SECTIONS = {
    ...
    "HAS_LICENCE_TYPE": [STANDARD],
    "HAS_TOLD_BY_OFFICIAL": [STANDARD],
    "HAS_GOODS": [STANDARD, EXHIBITION, GIFTING, F680],
    "HAS_GOODS_TYPES": [HMRC],
    "HAS_LOCATIONS": [HMRC, EXHIBITION],
    ...
    "HAS_NOTES": [STANDARD, EXHIBITION, F680, GIFTING],
    "HAS_END_USE_DETAILS": [STANDARD, F680],
    "END_USERS_OPTIONAL": [F680],
