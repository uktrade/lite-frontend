    ...
    return Form(
        ...
        questions=[
            ...
            HTMLBlock(
                ...
                + "</p>"
                + "<a class='govuk-link' href='https://www.great.gov.uk/advice/prepare-for-export-procedures-and-logistics/understand-international-trade-terms/'>Understand international trade terms</a>"
                + "</div>"
                + "</details>"
                "<br>"
            ),
