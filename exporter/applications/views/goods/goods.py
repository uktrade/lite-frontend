...
class SectionDocumentMixin:
    ...
    def get_section_document(self):
        ...
        if firearm_section == FirearmsActSections.SECTION_1:
            return documents[FirearmsActDocumentType.SECTION_1]
        elif firearm_section == FirearmsActSections.SECTION_2:
...
class IsGoodFirearm(LoginRequiredMixin, CheckNonFirearmEnabledMixin, FormView):
    ...
    def form_valid(self, form):
        if str_to_bool(form.data["is_firearm_product"]):
...
class AttachFirearmActSectionDocument(LoginRequiredMixin, TemplateView):
    def dispatch(self, request, **kwargs):
        ...
        if post_data["firearms_act_section"] == FirearmsActSections.SECTION_1:
            self.selected_section = "Section 1"
        elif post_data["firearms_act_section"] == FirearmsActSections.SECTION_2:
            self.selected_section = "Section 2"
        elif post_data["firearms_act_section"] == FirearmsActSections.SECTION_5:
...
def is_firearm_certificate_needed(application, selected_section):
    firearm_sections = [FirearmsActSections.SECTION_1, FirearmsActSections.SECTION_2]
