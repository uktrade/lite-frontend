...
class BaseEditView(
    ...
    def form_valid(self, form):
        edit_software(self.request, self.good["id"], self.get_edit_payload(form))
...
class BaseSofwareEditView(BaseEditView):
    def get_edit_payload(self, form):
        return get_cleaned_data(form)


class SoftwareEditName(BaseSofwareEditView):
...
class SoftwareEditControlListEntry(BaseSofwareEditView):
