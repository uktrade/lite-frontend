...
urlpatterns = [
    ...
    path("<uuid:pk>/select-entity-type/", common.ApplicationSelectEntityTypeSelectView.as_view(), name="select_entity_type"),
    path("<uuid:pk>/entity-not-available/<party_type>/", common.ApplicationEntityNotAvailableView.as_view(), name="entity_not_available"),
