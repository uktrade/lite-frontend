...
from exporter.applications.views.goods.add_good_technology.views.add import (
    AddGoodTechnology,
    AddGoodTechnologyToApplication,
)
from exporter.applications.views.goods.add_good_technology.views.edit import (
    TechnologyEditControlListEntry,
    TechnologyEditName,
    TechnologyEditPVGrading,
    TechnologyEditPVGradingDetails,
    TechnologyEditSecurityFeatures,
    TechnologyEditDeclaredAtCustoms,
    TechnologyEditProductDocumentAvailability,
    TechnologyEditProductDocumentSensitivity,
    TechnologyEditProductDocumentView,
    TechnologyEditProductDescriptionView,
    TechnologyEditPartNumberView,
    TechnologyEditMilitaryUseView,
    TechnologyOnApplicationSummaryEditOnwardExported,
    TechnologyOnApplicationSummaryEditOnwardAltered,
    TechnologyOnApplicationSummaryEditOnwardIncorporated,
    TechnologyOnApplicationSummaryEditQuantityValue,
)
from exporter.applications.views.goods.add_good_technology.views.summary import (
    TechnologyProductSummary,
    TechnologyProductOnApplicationSummary,
)
...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/add/technology/",
        AddGoodTechnologyToApplication.as_view(),
    ...
    path("<uuid:pk>/goods/add-new/technology/", AddGoodTechnology.as_view(), name="new_good_technology"),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_pk>/product-summary/",
        TechnologyProductSummary.as_view(),
        name="technology_product_summary",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/add-new/technology-to-application/",
        AddGoodTechnologyToApplication.as_view(),
        name="new_good_technology_to_application",
    ),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_on_application_pk>/technology-on-application-summary/",
        TechnologyProductOnApplicationSummary.as_view(),
        name="technology_on_application_summary",
    ),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_on_application_pk>/<str:summary_type>/edit/onward-exported/",
        TechnologyOnApplicationSummaryEditOnwardExported.as_view(),
        name="technology_on_application_summary_edit_onward_exported",
    ),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_on_application_pk>/<str:summary_type>/edit/onward-altered/",
        TechnologyOnApplicationSummaryEditOnwardAltered.as_view(),
        name="technology_on_application_summary_edit_onward_altered",
    ),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_on_application_pk>/<str:summary_type>/edit/onward-incorporated/",
        TechnologyOnApplicationSummaryEditOnwardIncorporated.as_view(),
        name="technology_on_application_summary_edit_onward_incorporated",
    ),
    path(
        "<uuid:pk>/goods/technology/<uuid:good_on_application_pk>/<str:summary_type>/edit/quantity-value/",
        TechnologyOnApplicationSummaryEditQuantityValue.as_view(),
        name="technology_on_application_summary_edit_quantity_value",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/name/",
        TechnologyEditName.as_view(),
        name="technology_edit_name",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/control-list-entries/",
        TechnologyEditControlListEntry.as_view(),
        name="technology_edit_control_list_entries",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/pv-grading/",
        TechnologyEditPVGrading.as_view(),
        name="technology_edit_pv_grading",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/pv-grading-details/",
        TechnologyEditPVGradingDetails.as_view(),
        name="technology_edit_pv_grading_details",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/security-features/",
        TechnologyEditSecurityFeatures.as_view(),
        name="technology_edit_security_features",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/declared-at-customs/",
        TechnologyEditDeclaredAtCustoms.as_view(),
        name="technology_edit_declared_at_customs",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/product-document-availability/",
        TechnologyEditProductDocumentAvailability.as_view(),
        name="technology_edit_product_document_availability",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/product-document-sensitivity/",
        TechnologyEditProductDocumentSensitivity.as_view(),
        name="technology_edit_product_document_sensitivity",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/product-document/",
        TechnologyEditProductDocumentView.as_view(),
        name="technology_edit_product_document",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/product-description/",
        TechnologyEditProductDescriptionView.as_view(),
        name="technology_edit_product_description",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/part-number/",
        TechnologyEditPartNumberView.as_view(),
        name="technology_edit_part_number",
    ),
    path(
        "<uuid:pk>/goods/<uuid:good_pk>/technology/edit/military-use/",
        TechnologyEditMilitaryUseView.as_view(),
