...
urlpatterns = [
    ...
    path("<uuid:pk>/detail/", views.F680ApplicationDetailView.as_view(), name="detail"),
    path("<uuid:pk>/details/<str:type>/", views.F680ApplicationDetailView.as_view(), name="detail"),
    path(
