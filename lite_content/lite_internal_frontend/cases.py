...
class CasesListPage:
    ...
    class Filters:
        ...
        MAX_SLA_DAYS_REMAINING = "max processing time remaining"
        MIN_SLA_DAYS_REMAINING = "min processing time remaining"
        SLA_DAYS_ELAPSED = "processing time elapsed"
        SUBMITTED_FROM = "submitted from date"
        SUBMITTED_TO = "submitted to date"
        FINALISED_FROM = "finalised from date"
        FINALISED_TO = "finalised to end date"
        ...
        FLAGS = "flags"
        SORT_BY_SLA_ELAPSED = "sorted by processing time"
